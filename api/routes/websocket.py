...
async def generic_voice_websocket(websocket: WebSocket, session_id: str, prompt_id: str = "sales_outbound"):
    ...
    session = session_manager.create_session(session_id, call_id, prompt_id)
...
async def twilio_media_stream_websocket(websocket: WebSocket, call_id: str, prompt_id: str = "sales_outbound"):
